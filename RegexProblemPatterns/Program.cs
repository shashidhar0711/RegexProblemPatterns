 ...
 *  
 *  Purpose: Validate the Last Name By Using Regular Expression
 *
 *  @author  Shashidhar C
 *  @version 1.0
 *  @since   18-10-2020
...
namespace RegexPoblemPatterns
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(pattern.ValidateFirstName("Shashi"));
            Console.WriteLine(pattern.ValidateLastName("Dhar"));
            Console.WriteLine(pattern.ValidateEmail("Shashidhar.sasic@gmail.com"));
        }
    }
}